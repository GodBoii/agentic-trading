    ...
    return (
      <div className="min-h-screen bg-brutal-black flex items-center justify-center p-6">
        <div className="w-full max-w-lg">
          <div className="brutal-box-lg p-12 text-center space-y-6 animate-pop">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-brutal-green border-4 border-brutal-black mb-6">
              <svg className="w-10 h-10 text-brutal-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={4}>
                <path strokeLinecap="square" strokeLinejoin="miter" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h2 className="text-4xl font-bold text-brutal-cream uppercase tracking-tight">Account Created!</h2>
      ...
      <div className="w-full max-w-lg">
        <div className="brutal-box-lg p-10 space-y-8 animate-pop">
          ...
          <div className="text-center">
            ...
            <h2 className="text-4xl font-bold text-brutal-cream uppercase tracking-tight mb-3">Create Account</h2>
            <p className="text-brutal-cream/60 font-mono uppercase tracking-wider text-sm">Join us today</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-6">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-bold text-brutal-cream mb-3 uppercase tracking-wider font-mono">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
