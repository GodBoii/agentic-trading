...
export default defineSchema({
  ...
  dhanCredentials: defineTable({
    ...
    tokenIssuedAt: v.optional(v.string()),
    tokenSource: v.optional(v.string()),
    accountVerifiedAt: v.optional(v.string()),
    encryptedPin: v.optional(v.string()),
    encryptedTotpSecret: v.optional(v.string()),
    autoRenew: v.optional(v.boolean()),
    authStatus: v.optional(v.string()),
    lastCheckedAt: v.optional(v.string()),
    lastRenewedAt: v.optional(v.string()),
