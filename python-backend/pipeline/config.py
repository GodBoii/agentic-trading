...
class PipelineConfig:
    ...
    multimodal_model_id: str = "deepseek/deepseek-v4.1-flash"
    regime_model_id: str = "deepseek/deepseek-v4.1-flash"
    ...
    stage1_schedule_time: str = "06:00"
    stage1_premarket_start_cutoff_time: str = "07:30"
    stage1_premarket_completion_time: str = "09:00"
    stage1_max_run_seconds: int = 10800
    ...
    stock_agent_max_concurrent_events: int = 10
