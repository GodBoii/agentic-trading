# Dhan HQ Orders API Documentation
...
**Note:** Order Placement, Modification and Cancellation APIs requires Static IP whitelisting - [Setup Instructions](https://dhanhq.co/docs/v2/authentication/#setup-static-ip)
...
| amoTime<br>_conditionally required_ | enum string | Timing to pump the after market order<br>`PRE_OPEN` `OPEN` `OPEN_30` `OPEN_60` |
...
### Response Parameters
_(Same as Order Book response parameters)_

---

## Get Order by Correlation Id

In case the user has missed order id due to unforeseen reason, this API retrieves the order status using a tag called correlation id specified by users themselves.
...
### Response Structure
_(Same as Get Order by Order Id)_
...
### Response Parameters
_(Same as Trade Book response parameters)_
